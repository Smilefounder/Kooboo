...
{
    public class LogiticsCallBackApi : IApi, IDynamicApi
    {
        public string ModelName => "Logiticscallback";
        ...
        public DynamicApi GetMethod(string name)
        {
            ...
            var paymentmethod = LogisticsManager.GetMethod(paymentname);
        ...
        public IResponse Callback(ApiCall call)
        {
            ...
            var paymentmethod = LogisticsManager.GetMethod(paymentname, call.Context);
            ...
            if (paymentmethod != null)
            {
                ...
                if (method != null)
                {
                    ...
                    para[0] = call.Context;
                    var result = method.Invoke(paymentmethod, para) as LogisticsCallback;

                    if (result != null)
                    {
                        LogisticsManager.CallBack(result, call.Context);
