...
namespace ConditionParser.Models
{
    public class Iterator
    {
        ...
        public DmlValueExpression ExtractValue(bool sureToBeString = false)
        {
            ...
            TrimStart();
            return new DmlValueExpression(valueBuilder.ToString(), wrapSymbol.HasValue || sureToBeString);
        }
    }
}
